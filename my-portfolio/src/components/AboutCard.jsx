    ...
    <div className="min-h-screen bg-white flex flex-col md:flex-row">
      ...
      <div className={`w-full md:w-1/2 flex flex-col justify-center px-6 py-8 md:px-16 md:py-16 bg-white transition-all duration-1000 ease-out ${
        ...
        <div className="space-y-6 md:space-y-8 text-center md:text-left">
          ...
          <p className={`text-blue-800 text-base md:text-lg leading-relaxed max-w-md mx-auto md:mx-0 transition-all duration-1000 ease-out delay-400 ${
            pageLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}>
      ...
      <div className={`w-full md:w-1/2 bg-blue-800 relative overflow-hidden min-h-[80vh] md:min-h-full transition-all duration-1000 ease-out delay-300 ${
        ...
        <div className={`absolute inset-0 bg-white border border-blue-800 border-4 md:border-8 p-4 md:p-8 flex flex-col transition-transform duration-700 ease-in-out transform-gpu ${
          ...
          <div className="space-y-3 md:space-y-6 flex-1">
            <p className="text-sm md:text-3xl text-blue-800 leading-relaxed font-bold">
