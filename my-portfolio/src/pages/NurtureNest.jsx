...
const NurtureNest = () => {
    ...
    const desktopImages = [
        ...
        '/NurtureNest/nn7.jpg',
        '/NurtureNest/nn8.jpg',
        '/NurtureNest/nn9.jpg', // Reusing first mobile image for 9th slide
        '/NurtureNest/nn10.jpg',
        '/NurtureNest/nn11.jpg',
    ];
    ...
    const mobileImages = [
        ...
        '/NurtureNest/nm7.jpg',
        '/NurtureNest/nm8.jpg',
        '/NurtureNest/nm9.jpg', // Reusing first mobile image for 9th slide
        '/NurtureNest/nm10.jpg',
        '/NurtureNest/nm11.jpg', // Reusing second mobile image for 10th slide
    ];
